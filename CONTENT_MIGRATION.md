...
1. Visit the CiviCRM [Relationships Report](https://SpotlightKenya.org/civicrm/report/instance/5)
...
- [Authors](https://SpotlightKenya.org/export/magazine_authors_uncleaned.csv)
- [Departments](https://SpotlightKenya.org/export/magazine_departments.csv)
- [Issues](https://SpotlightKenya.org/export/magazine_issues.csv)
- [Articles](https://SpotlightKenya.org/export/magazine_articles.csv)
