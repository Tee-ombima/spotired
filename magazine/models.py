...
class MagazineIssue(Page):
    ...
    #     blank=True,
    #     related_name="+",
    #     help_text="Upload a PDF document for this issue. Note that the document will be embedded in the page and controls will be added to prohibit downloading.",
    # )
...
class ArchiveIssue(Page):
    ...
    western_friend_volume = models.CharField(
        max_length=255,
        help_text="Related Spotlight Kenya volume.",
        null=True,
        blank=True,
    )
